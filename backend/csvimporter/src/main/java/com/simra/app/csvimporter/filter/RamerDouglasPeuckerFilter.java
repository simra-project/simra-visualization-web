...
public class RamerDouglasPeuckerFilter {
    ...
    private static final void douglasPeucker(List<RideCSV> list, int s, int e, double epsilon, List<RideCSV> resultList) {
     ...
     */
    public static final List<RideCSV> douglasPeucker(List<RideCSV> list, double epsilon) {
        final List<RideCSV> resultList = new ArrayList<RideCSV>();
